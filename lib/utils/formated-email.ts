      ...
      <tbody>
        <tr>
          <td style="width: 596px; vertical-align: top; padding-left: 0; padding-right: 0; padding-top: 15px; padding-bottom: 15px;" width="596">
            ...
            <!-- Your logo is here -->
            <img style="width: 280px; max-width: 280px; height: 185px; max-height: 185px; text-align: center; color: #ffffff;" alt="Logo" src="https://minhajsorder.com/images/ashra-academy.png" align="center" width="180" height="85">
        ...
        <tbody>
          <tr>
            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;" width="596">
              ...
              <h2 style="font-size: 18px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 600; text-decoration: none; color: #000000;">Do not share your otp with othere.</h2>

              <p style="font-size: 15px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 400; text-decoration: none; color: #919293;">Enjoy your chat assistant.</p>              
